...
export default function ApartmentDashboard() {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-white">
      <h1 className="text-2xl font-medium text-gray-700 mb-8">Cosgrove Greenview Apartments</h1>
      ...
      <div className="grid grid-cols-2 gap-8 mb-12">
        ...
        <div className="bg-gray-100 p-6 rounded-lg">
          <div className="inline-block border border-dotted border-blue-400 px-3 py-1 rounded text-blue-600 mb-2">MoM Growth</div>
